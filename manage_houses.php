      ...
      <div class="row my-4">
        <?php
            ...
            while($row = $result->fetch(PDO::FETCH_ASSOC)) {
                echo '<div class="col-lg-3 my-2"> <div class="card py-5 gradient-custom-3"><div class="card-body mx-auto my-auto h5 text-light"><form action="house_details.php" method="POST"><input type="hidden" name="house_no" value="'.$row["House Number"].'"><button type="submit" style="all:unset;cursor:pointer;"> House No: <span class="text-danger py-2 px-2 badge badge-light">'.$row["House Number"].'</span></button></form></div></div></div>';
            }
        ?>
      </div>
    </div>
